...
ip2location_url = 'https://github.com/Darandra/huyailtools/releases/download/ip2location/ip2location.bin'
...
try:
	help_message = f'usage:\n    python3 <(curl -fskSL https://raw.githubusercontent.com/Darandra/huyailtools/main/remove-dangerous-emails/get_safe_mails.py) '+bold('list_with_emails.txt')+' [selected,email,providers]'
