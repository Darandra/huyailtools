...
autoconfig_data_url = 'https://raw.githubusercontent.com/Darandra/huyailtools/main/smtp-checker/autoconfigs_enriched.txt'
	...
	banner = f"""
         ...
         ╙█                           ╙                                         
          ╙     {b}MadCat SMTP Checker & Cracker v23.03.30{z}
                Made by {b}Darandra{z} for community: {b}https://xss.is{z} - forum of security professionals
                https://github.com/Darandra/huyailtools
	"""
...
check_ipv6()
try:
	help_message = f'usage: \n{npt}python3 <(curl -slkSL https://raw.githubusercontent.com/Darandra/huyailtools/main/smtp-checker/mailpass2smtp.py) '+bold('list.txt')+' [verify_email@example.com] [ignored,email,domains] [start_from_line] [debug]'
